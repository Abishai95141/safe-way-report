          ...
          >
            ...
            >
              ...
              <p className="text-lg text-foreground/80 leading-relaxed font-light">
                I am an AI practitioner who believes that the best code is the
                kind that can be explained. My background spans Machine
                Learning, Deep Learning, and LLMs, honed through competitive
                datathons and internship roles. I love the challenge of
                research, but I'm equally passionate about
                communication—breaking down technical complexity to collaborate
